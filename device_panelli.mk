...
LOCAL_PATH := device/motorola/panelli

$(call inherit-product-if-exists, vendor/motorola/panelli/panelli-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/motorola/panelli/overlay
PRODUCT_PACKAGE_OVERLAYS += device/motorola/panelli/overlay # enable this to be able overlay a default wallpaper
